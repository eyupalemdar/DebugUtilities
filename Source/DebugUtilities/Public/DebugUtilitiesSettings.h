...
#include "DebugUtilitiesSettings.generated.h"
...
class DEBUGUTILITIES_API UDebugUtilitiesSettings final : public UObject
{
	GENERATED_BODY()

public:
	UDebugUtilitiesSettings(const FObjectInitializer& ObjectInitializer);
